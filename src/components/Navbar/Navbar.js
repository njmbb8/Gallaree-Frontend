                        ...
                        <Nav className="me-2">
                            ...
                            {Object.entries(user).length > 0 && !!order ?
                                <> 
                                    ...
                                    {!user.admin ? <Navbar.Text onMouseOver={(e)=> e.target.style.cursor = 'pointer'} onClick={expandOrder}>({Object.entries(order).length > 0 ? order.items.length : null})</Navbar.Text> : null}
